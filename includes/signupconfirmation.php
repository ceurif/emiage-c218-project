...
if (isset($_POST['signup'])) {
    ...
    if($password != $confirmation) {
        echo "<h5 class='red - text'>Error on password confirmation</h5>";
    } else{
        $encryptedpass = md5($password);

        include 'db.php';
        //connecting & inserting data
        $query = "INSERT INTO users(email, firstname, lastname, password, address, city, country,role) VALUES ('$email',
'$firstname','$lastname','$encryptedpass','$address','$city','$country','client')";
