            ...
            <div class="nav-wrapper">
                <form method="GET" action="search.php">
                    ...
                    <div class="center-align">
                        <button type="submit" name="search" class="blue waves-light miaw waves-effect btn hide">Search
                        </button>
                    </div>
                </form>
            </div>
                    ...
                    <div class="card hoverable animated slideInUp wow">
                        <div class="card-image">
                            ...
                            <a href="product.php?id=<?= $id_best; ?>"
                               class="btn-floating red halfway-fab waves-effect waves-light right"><i
                        ...
                        <div class="card-content">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col s6">
                                        <p class="white-text"><i
                                                    class="left fa fa-shopping-basket"></i> <?= $totalsold; ?></p>
                                    </div>
                                </div>
                            </div>
            ...
            if ($total->num_rows > 0) {
                ...
                while ($rowcategory = $total->fetch_assoc()) {
                    ...
                    <div class="col s12 m4">
                        <div class="card hoverable animated slideInUp wow">
                            <div class="card-image">
                                <a href="category.php?id=<?= $id_category; ?>"><img
                                            src="src/img/<?= $icon_category; ?>.png" alt=""></a>
